        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-slate-400 text-lg leading-relaxed max-w-2xl mx-auto">
              Khám phá các gói ưu đãi độc quyền được thiết kế riêng để nâng tầm
              trải nghiệm du ngoạn của bạn cùng OceanaLux.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-amber-50 py-16 text-center px-4 border-t border-amber-100">
        <div className="max-w-2xl mx-auto">
          ...
          <h3 className="text-2xl font-serif font-bold text-slate-900 mb-4">
            Nhận Thêm Nhiều Đặc Quyền?
          </h3>
          <p className="text-slate-600 mb-8">
            Đăng ký thành viên OceanaLux ngay hôm nay để nhận thông báo sớm nhất
            về các chương trình Flash Sale và tích điểm đổi chuyến đi.
          </p>
          <button
