...
export function BookingPage() {
  ...
  if (!cruise || !cabin)
    return <div className="p-20 text-center">Invalid booking request.</div>;
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex items-center justify-between relative before:absolute before:inset-0 before:top-1/2 before:-translate-y-1/2 before:h-0.5 before:bg-slate-200 before:z-0">
              {steps.map((s, idx) => (
                ...
                >
                  ...
                  <span
                    className={`text-xs font-semibold uppercase tracking-wider mt-2 ${step >= s.id ? "text-slate-900" : "text-slate-400"}`}
                  >
                    {s.title}
                  </span>
                </div>
            ...
            <form onSubmit={handleNext}>
              {step === 1 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-serif font-bold text-slate-900 border-b border-slate-100 pb-4">
                    Lead Guest Details
                  </h2>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">
                      Number of Guests (including lead)
                    </label>
                    <select
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all"
              ...
              {step === 2 && (
                <div className="space-y-6">
                  ...
                  <p className="text-slate-600 mb-4">
                    Please provide any special requests or dietary requirements.
                  </p>
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">
                      Special Requests
                    ...
                    <textarea
                      rows={4}
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all resize-none"
                      placeholder="e.g., Anniversary celebration, allergies, accessibility needs..."
                    ></textarea>
                  </div>
                  ...
                  <div className="bg-amber-50 p-4 rounded-xl border border-amber-200 flex gap-4 mt-6 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-800 mt-1">
                        We strongly advise purchasing travel insurance for your
                        voyage. You can add this during checkout.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex justify-between items-center">
                ...
                <button
                  type="submit"
                  className="bg-slate-900 text-white px-8 py-3 rounded-lg font-bold hover:bg-amber-500 hover:text-slate-900 transition-all shadow-lg flex items-center gap-2"
                >
        ...
        <div className="lg:w-1/3 order-1 lg:order-2">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 mb-6 flex items-center justify-between text-white shadow-xl relative overflow-hidden">
            ...
            <div>
              <h4 className="font-bold text-sm uppercase tracking-wider text-amber-500 mb-1">
                Room Held For
              </h4>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden sticky top-28">
            ...
            <div className="p-6">
              <h4 className="text-lg font-bold text-slate-900 mb-4 pb-4 border-b border-slate-100">
                Booking Summary
              </h4>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-600">
                    Departing from{" "}
                    {cruise.itinerary[0]?.location.split(",")[0] || "TBA"}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-slate-600">
                    Cabin Price ({formData.guests} guests)
                  </span>
