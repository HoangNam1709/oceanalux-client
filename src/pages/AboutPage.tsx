    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/billy-pasco-F5oj6SYoarc-unsplash.jpg')",
          }}
        ></div>
        ...
        <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6">
              Định Nghĩa Lại Sự Xa Hoa
            </h1>
            <p className="text-lg md:text-xl text-slate-200 font-light leading-relaxed max-w-2xl mx-auto">
              Hành trình của chúng tôi bắt đầu từ tình yêu mãnh liệt với biển cả
              và khát vọng mang đến những trải nghiệm du ngoạn hoàn mỹ nhất tại
              Vịnh Hạ Long.
            </p>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h2 className="text-4xl font-serif font-bold text-slate-900 leading-tight">
              Hơn cả một chuyến đi, <br /> đó là một{" "}
              <span className="text-amber-500">di sản</span>.
            </h2>
            <p className="text-slate-600 leading-relaxed text-lg">
              Được thành lập vào năm 2010, OceanaLux khởi đầu với một chiếc
              thuyền gỗ nhỏ. Trải qua hơn một thập kỷ, chúng tôi đã vươn mình
              trở thành đội tàu du lịch sang trọng bậc nhất Vịnh Bắc Bộ.
            </p>
            <p className="text-slate-600 leading-relaxed text-lg">
              Mỗi chiếc du thuyền của chúng tôi không chỉ là một kiệt tác kỹ
              thuật số, mà còn là một bảo tàng nổi tôn vinh nét đẹp văn hóa
              truyền thống Việt Nam kết hợp cùng sự tiện nghi hiện đại của
              phương Tây.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-800">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl md:text-5xl font-serif font-bold text-amber-500 mb-2">
                  {stat.number}
                </div>
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-16">
      ...
      <section className="py-20 bg-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-6">
            Bạn Đã Sẵn Sàng Vươn Khơi?
          </h2>
          <p className="text-slate-600 text-lg mb-10 max-w-2xl mx-auto">
            Hãy để chúng tôi biến kỳ nghỉ trong mơ của bạn thành hiện thực. Đặt
            phòng ngay hôm nay để nhận những ưu đãi đặc biệt nhất.
          </p>
          <button
