                        ...
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 border rounded-lg font-bold text-sm flex items-center gap-2 transition-colors ${
                              hasNoImages
                                ? "bg-[#D4AF37]/10 text-[#B8912A] border-[#D4AF37]/30 hover:bg-[#D4AF37]/20" //
                          ...
                          <button
                            ...
                            className="px-3 py-2 bg-white border border-slate-200 text-slate-400 rounded-lg hover:border-[#D4AF37] hover:text-[#D4AF37] hover:bg-[#D4AF37]/10 transition-all shrink-0"
                            title="Xóa tàu"
                          >
